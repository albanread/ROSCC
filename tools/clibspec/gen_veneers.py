...
def main():
    ...
    asm.append(f"    .space {k_n * 4}      @ veneer literal pool slack (found live:")
    asm.append("                        @  the module writes LDR pc,[pc,#imm] literals")
    asm.append("                        @  past the table end)")
    asm.append("")
    ...
    asm.append(f"    .space {c_n * 4}      @ veneer literal pool slack")
    asm.append("")
    ...
    asm.append("    .space 4096        @ sacrificial: the module's veneer literal pool")
    asm.append("")
